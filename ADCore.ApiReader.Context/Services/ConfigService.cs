...
namespace ADCore.ApiReader.Context.Services
{
    public class ConfigService : IConfigService
    {
        ...
        public ConfigService(IApiClient apiClient, IMapperService mapperService, ILogger<ConfigService> logger)
        {
        ...
        public MarketCapResponse MapToModel(string jsonData, Config config)
        {
            Resource res = new Resource() { Data = jsonData, Config = config };
            _ = MapperService.TryMap<MarketCapResponse>(res, out object marketCapResponse);
            return (MarketCapResponse)marketCapResponse;
        }
    }
}