...
using ADCore.Binance.CryptoPairWatcher.Extensions;
...
{
    public class BinanceDbContext : DbContext, IUnitOfWork
    {
        public BinanceDbContext(DbContextOptions<BinanceDbContext> options) : base(options)
        { }

        public virtual DbSet<PairExchange> PairExchanges { get; set; }
        ...
        private void validateEntities()
        {
            ...
            if (!string.IsNullOrWhiteSpace(errors))
            {
                ...
                var logger = loggerFactory.CreateLogger<BinanceDbContext>();
