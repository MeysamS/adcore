...
namespace ADCore.Binance.CryptoPairWatcher.Services
{
    public interface IConfigService
    {
        ...
        PairResponse MapToModel(string jsonData, Config config);
    }
    ...
    public class ConfigService : IConfigService
    {
        ...
        public PairResponse MapToModel(string jsonData, Config config)
        {
            Resource res = new Resource() { Data = jsonData, Config = config };
            _ = MapperService.TryMap<PairResponse>(res, out object resp);
